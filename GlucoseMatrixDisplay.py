...
class GlucoseMatrixDisplay:
    ...
    def build_pixel_matrix(self):
        ...
        pixelMatrix.draw_vertical_line(self.matrix_size - 1 - 12, self.fade_color(Color.white, 0.01),
                                       self.GLUCOSE_HIGHT, 18, blink=True)
        pixelMatrix.draw_vertical_line(self.matrix_size - 1 - 24, self.fade_color(Color.white, 0.01),
                                       self.GLUCOSE_HIGHT, 18, blink=True)
